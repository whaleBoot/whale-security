package com.whale.security.core.social.weixin.config;

import com.whale.security.core.properties.QQProperties;
import com.whale.security.core.properties.SecurityProperties;
import com.whale.security.core.properties.WeixinProperties;
import com.whale.security.core.social.WhaleConnectView;
import com.whale.security.core.social.qq.connet.QQOAuth2ConnectionFactory;
import com.whale.security.core.social.weixin.connet.WeixinConnectionFactory;
 ...
 * @Description 微信登录配置
 * @Author like
 * @Data 2019/9/25 14:02
 * @Version 1.0
 **/
@Configuration
@ConditionalOnProperty(prefix = "whale.security.social.weixin", name = "appId")
